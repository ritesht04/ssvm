...
<body onload="generate()">
    ...
    $sql1 = "INSERT INTO `ssvm`.`registration` (name, father, mother, cname, userid, gap, email, contact, dob, gender, city, street) VALUES ('$name', '$father', '$mother', '$cname', '$userid', '$gap', '$email', '$contact', '$dob', '$gender', '$city', '$street');";
